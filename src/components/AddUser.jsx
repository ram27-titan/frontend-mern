...
const AddUser = () => {
  ...
  return (
    <div>
      <h1 className="font-bold text-blue-600 mt-5 ml-20 text-2xl ">Form Add User</h1>

      <form onSubmit={postUser} className="w-full bg-blue-600 border border-blue-900 rounded-2xl mt-2 ml-20 p-4 max-w-sm">
